...
export const EN_PROFANITY = new Set([
  ...
  'big knockers', 'big tits', 'bimbos', 'birdlock', 'bitch', 'bitches', 'biatch',
  'black cock',
  ...
  'eat my ass', 'ecchi', 'erotic', 'erotism', 'escort',
  ...
  'gang bang', 'gangbang', 'gay sex', 'giant cock',
  ...
  'nimphomania', 'nsfw images', 'nude', 'nudity',
  'nympho', 'nymphomania', 'octopussy', 'omorashi', 'one cup two girls',
  'one guy one jar', 'orgy', 'paedophile', 'paki', 'panties',
  'panty', 'pedobear', 'pedophile', 'pegging', 'phone sex',
  ...
  'santorum', 'scat', 'schlong', 'scissoring', 'sexcam',
  'sexy', 'shaved beaver',
  ...
  'upskirt', 'urethra play', 'urophilia', 'venus mound',
  'vibrator', 'violet wand', 'vorarephilia', 'voyeur', 'wank',
